  ...
  try {
    ...
    const usersData = [
      ...
      },
      {
        id: 'sadfj02f3fw',
        name: 'Bob Johnson',
        division: { connect: { id: divisions[2].id } },
        institution: { connect: { id: institutions[1].id } },
      },
      {
        id: 'dsau0f92u2',
        name: 'Alice Williams',
        division: { connect: { id: divisions[3].id } },
    ...
    const complaintsData = [
      {
        complaint_title: 'Injured Wildlife',
        complaint_description: 'Found an injured bird near the park.',
        complainer: { connect: { id: publicUsers[0].id } },
        assignedInstitution: { connect: { id: institutions[0].id } },
      },
      {
        complaint_title: 'Illegal Poaching',
        complaint_description: 'Witnessed illegal hunting activity in the forest.',
        complainer: { connect: { id: publicUsers[1].id } },
        assignedInstitution: { connect: { id: institutions[1].id } },
      },
    ];
    ...
    const workflowsData = [
      ...
      {
        institution: { connect: { id: institutions[1].id } },
        stages: ['Incident Report Intake', 'Coordinating with Law Enforcement', 'Legal Proceedings'],
      },
    ];
    ...
    const investigationsData = [
      {
        ...
        complaint: { connect: { id: complaints[0].id } },
        office: { connect: { id: offices[0].id } },
        division: { connect: { id: divisions[0].id } },
      },
      {
        institution: { connect: { id: institutions[1].id } },
        workflow: { connect: { id: workflows[1].id } },
        complaint: { connect: { id: complaints[1].id } },
        office: { connect: { id: offices[2].id } },
        division: { connect: { id: divisions[2].id } },
      },
    ];
